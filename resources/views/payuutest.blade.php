...
<body class="antialiased">
    <div class="iphone">
        <header class="header">
            <h1>Pasarela de Prueba</h1>
        </header>

        <form action="{{ route('payu.payment.test') }}" class="form" method="POST">
            ...
            <div>
                <h2>Datos de la persona que paga</h2>
            ...
            <div>
                ...
                <div class="card">
                    <address>
                        <strong style="color: black">Impuesto IVA: </strong>
                        0<br />
                        <strong style="color: black">Impuesto VAT: </strong>
                        0<br />
                        <strong style="color: black">Moneda: </strong>
                ...
                <div class="form__radios">
                    <div class="form__radio">
                        <label for="American Express">
                            <img src="https://s1.q4cdn.com/692158879/files/images/brand_imagery/AXP_BlueBoxLogo_EXTRALARGEscale_RGB_DIGITAL_1600x1600.png"
                                width="30" height="30">
                            American Express Payment
                        </label>
                        <input id="amex" name="payment_method" type="radio" value="AMEX" />
                    </div>

                    <div class="form__radio">
                        <label for="Codensa">
                            <img src="http://developers.payulatam.com/latam/assets/PaymentMethods/codensa.png"
                                width="30" height="30">
                            Codensa
                        </label>
                        <input id="codensa" name="payment_method" type="radio" value="CODENSA" />
                    </div>

                    <div class="form__radio">
                        <label for="Diners">
                            <img src="http://developers.payulatam.com/latam/assets/PaymentMethods/diners.png" width="30"
                                height="30">
                            Diners
                        </label>
                        <input id="diners" name="payment_method" type="radio" value="DINERS" />
                    </div>
                    ...
                    <div class="form__radio">
                        ...
                        <input checked id="visa" name="payment_method" type="radio" value="VISA" />
                    </div>
                    ...
                    <div class="form__radio">
                        ...
                        <input id="mastercard" name="payment_method" type="radio" value="MASTERCARD" />
                    </div>
                </div>
            </fieldset>
            ...
            <div>
                ...
                <div class="card">
                    <address>
                        <strong style="color: black"> Numero De La Tarjeta: </strong>
                        <input style="color: black" checked id="credit_card_number" name="credit_card_number"
                            type="number" value=0 /><br />
                    </address>
                    <br />
                    <address>
                        <strong style="color: black">Fecha Expiración: </strong><br />
                        Año
                    ...
                    <br />
                    <address>
                        <strong style="color: black"> Codigo Seguridad de Tarjeta: </strong>
                        <input style="color: black" checked id="credit_card_security_code"
                            name="credit_card_security_code" type="number" value=0 /><br />
                    </address>
                </div>
            </div>
